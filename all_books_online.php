			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-header align-center">
						<h2 class="section-title">All Books Read Online</h2>
					</div>
							...
							<figure class="product-style">
								<img src="<?php echo htmlspecialchars($book['Image']); ?>" 
									...
									<?php if ($Permission == '1') { ?>
										...
										<button type="button" class="add-to-cart" data-product-tile="add-to-cart" onclick="window.location.href='reader_router.php?type_id=<?=$book['TypeID']?>&book_id=<?=$book['BookID']?>?>'">Read Online</button>
